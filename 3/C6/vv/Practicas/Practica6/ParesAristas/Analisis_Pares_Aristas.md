...
| 5 | (1,21) | N1 -> N2 -> N1 | SistemaReservas.java, QuadListActivity.java | Flujo de ida y vuelta: se abre el listado (A1) y se pulsa el botón de retorno (A21) que finaliza la actividad volviendo al menú. |
...
| 22 | (11,20) | N5 -> N6 -> N6 | ReservaEdit.java, QuadSelectionActivity.java | Apertura de selección (A11). En N6 se pulsa ordenar por matrícula (A20) para facilitar la localización de un vehículo. |
| 23 | (11,20b) | N5 -> N6 -> N6 | ReservaEdit.java, QuadSelectionActivity.java | Entrada a selección (A11). Uso del botón de ordenación por tipo (A20b) dentro de la actividad de selección N6. |
| 24 | (11,20c) | N5 -> N6 -> N6 | ReservaEdit.java, QuadSelectionActivity.java | Navegación a N6 (A11). Aplicación del filtro de ordenación por precio diario (A20c). |
| 25 | (11,23) | N5 -> N6 -> N6 | ReservaEdit.java, QuadSelectionActivity.java | En N6 (tras A11), el usuario pulsa en el botón de detalles (A23) de un quad para ver su descripción técnica. |
| 26 | (11,24) | N5 -> N6 -> N6 | ReservaEdit.java, QuadSelectionAdapter.java | Tras abrir N6 (A11), se selecciona un quad lo que habilita el botón de popup para elegir el número de cascos (A24). |
...
| 31 | (12,19) | N6 -> N5 -> N5 | QuadSelectionActivity.java, ReservaEdit.java | Vuelta a N5 con quads (A12). El usuario pulsa en el selector de fecha de recogida (A19) para modificarla antes de confirmar. |
| 32 | (12,19b) | N6 -> N5 -> N5 | QuadSelectionActivity.java, ReservaEdit.java | Confirmación en N6 (A12). En N5 se ajusta la fecha de devolución (A19b) mediante el DatePickerDialog. |
...
| 40 | (12b,19) | N6 -> N5 -> N5 | QuadSelectionActivity.java, ReservaEdit.java | Cancelación en N6 (A12b). En N5 se reajusta la fecha de recogida (A19) para ver si hay otros quads disponibles. |
| 41 | (12b,19b) | N6 -> N5 -> N5 | QuadSelectionActivity.java, ReservaEdit.java | Tras salir de N6 (A12b), se modifica la fecha de devolución (A19b) en el formulario N5. |
...
| 49 | (12c,19) | N6 -> N5 -> N5 | QuadSelectionActivity.java, ReservaEdit.java | Salida de N6 (A12c) y ajuste de fecha de recogida (A19). |
| 50 | (12c,19b) | N6 -> N5 -> N5 | QuadSelectionActivity.java, ReservaEdit.java | Retorno a N5 (A12c) y cambio de fecha de devolución (A19b). |
...
| 58 | (13,21) | N2 -> N2 -> N1 | QuadListActivity.java | Ordenación de lista (A13) y posterior salida al menú principal (A21). |
...
| 64 | (13b,21) | N2 -> N2 -> N1 | QuadListActivity.java | Filtro de tipo (A13b) y retorno al menú (A21). |
...
| 70 | (13c,21) | N2 -> N2 -> N1 | QuadListActivity.java | Filtro por precio (A13c) y vuelta al menú (A21). |
...
| 76 | (14,21) | N2 -> N2 -> N1 | QuadListActivity.java | Borrado de un elemento (A14) y salida al menú (A21). |
...
| 104 | (16,22) | N4 -> N4 -> N1 | ReservaListActivity.java | Ordenar por cliente (A16) y volver al menú principal (A22). |
...
| 116 | (16b,22) | N4 -> N4 -> N1 | ReservaListActivity.java | Ordenar por teléfono (A16b) y salir al menú (A22). |
...
| 128 | (16c,22) | N4 -> N4 -> N1 | ReservaListActivity.java | Ordenar por fecha (A16c) y volver al menú (A22). |
...
| 140 | (16d,22) | N4 -> N4 -> N1 | ReservaListActivity.java | Ordenar (A16d) y volver al menú (A22). |
...
| 152 | (16e,22) | N4 -> N4 -> N1 | ReservaListActivity.java | Filtrar Previstas (A16e) y volver al menú (A22). |
...
| 164 | (16f,22) | N4 -> N4 -> N1 | ReservaListActivity.java | Filtrar Vigentes (A16f) y volver al menú (A22). |
...
| 176 | (16g,22) | N4 -> N4 -> N1 | ReservaListActivity.java | Filtrar Caducadas (A16g) y volver al menú (A22). |
...
| 188 | (16h,22) | N4 -> N4 -> N1 | ReservaListActivity.java | Ver todas (A16h) y volver al menú principal (A22). |
...
| 200 | (17,22) | N4 -> N4 -> N1 | ReservaListActivity.java | Ver detalles (A17) y volver al menú principal (A22). |
...
| 212 | (18,22) | N4 -> N4 -> N1 | ReservaListActivity.java | Finalizar envío (A18) y volver al menú principal (A22). |
...
| 224 | (2,22) | N1 -> N4 -> N1 | SistemaReservas.java, ReservaListActivity.java | Abrir listado de reservas (A2) y volver inmediatamente al menú (A22). |
...
| 226 | (19,10) | N5 -> N5 -> N1 | ReservaEdit.java | Se selecciona la fecha de recogida (A19) y se procede a guardar la reserva (A10) hacia el menú principal. |
| 227 | (19,10b) | N5 -> N5 -> N1 | ReservaEdit.java | Se ajusta la fecha (A19) pero el usuario decide cancelar la reserva (A10b). |
| 228 | (19,10c) | N5 -> N5 -> N1 | ReservaEdit.java | Cambio de fecha (A19) y salida por botón atrás físico (A10c) a N1. |
| 229 | (19,11) | N5 -> N5 -> N6 | ReservaEdit.java, QuadSelectionActivity.java | Se define la fecha de recogida (A19). Con las fechas listas, se abre la selección de quads (A11). |
| 230 | (19,19) | N5 -> N5 -> N5 | ReservaEdit.java | Apertura repetida del selector de fecha de recogida en el formulario. |
| 231 | (19,19b) | N5 -> N5 -> N5 | ReservaEdit.java | Se define la recogida (A19) y luego la devolución (A19b). |
| 232 | (19,9) | N5 -> N5 -> N4 | ReservaEdit.java | En edición, se cambia fecha recogida (A19) y se guarda (A9) hacia N4. |
| 233 | (19,9b) | N5 -> N5 -> N4 | ReservaEdit.java | Cambio de fecha (A19) y cancelación de edición (A9b) hacia N4. |
| 234 | (19,9c) | N5 -> N5 -> N4 | ReservaEdit.java | Cambio de fecha (A19) y atrás físico (A9c) hacia el listado N4. |
| 235 | (19b,10) | N5 -> N5 -> N1 | ReservaEdit.java | Se ajusta la fecha de devolución (A19b) y se guarda la reserva (A10). |
| 236 | (19b,10b) | N5 -> N5 -> N1 | ReservaEdit.java | Cambio de fecha devolución (A19b) y cancelación (A10b). |
| 237 | (19b,10c) | N5 -> N5 -> N1 | ReservaEdit.java | Cambio de fecha (A19b) y atrás físico (A10c). |
| 238 | (19b,11) | N5 -> N5 -> N6 | ReservaEdit.java, QuadSelectionActivity.java | Tras definir la devolución (A19b), se procede a seleccionar los vehículos (A11). |
| 239 | (19b,19) | N5 -> N5 -> N5 | ReservaEdit.java | Ajuste de devolución (A19b) y re-ajuste de recogida (A19). |
| 240 | (19b,19b) | N5 -> N5 -> N5 | ReservaEdit.java | Apertura repetida del diálogo de fecha de devolución. |
| 241 | (19b,9) | N5 -> N5 -> N4 | ReservaEdit.java | Cambio de devolución en edición (A19b) y guardado (A9) a N4. |
| 242 | (19b,9b) | N5 -> N5 -> N4 | ReservaEdit.java | Cambio de fecha (A19b) y cancelación de edición (A9b). |
| 243 | (19b,9c) | N5 -> N5 -> N4 | ReservaEdit.java | Cambio de fecha (A19b) y atrás físico (A9c). |
| 244 | (20,12) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Se ordena por matrícula en selección (A20) y se confirma la elección (A12) volviendo a N5. |
| 245 | (20,12b) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Ordenación (A20) y cancelación de la selección (A12b). |
| 246 | (20,12c) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Ordenación (A20) y botón atrás (A12c) hacia el formulario N5. |
| 247 | (20,20) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Re-aplicación del orden por matrícula en la pantalla de selección. |
| 248 | (20,20b) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Cambio de ordenación en N6: de Matrícula (A20) a Tipo (A20b). |
| 249 | (20,20c) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Cambio de ordenación en N6: de Matrícula (A20) a Precio (A20c). |
| 250 | (20,23) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Ordenación por matrícula (A20) y consulta de detalles de un quad (A23). |
| 251 | (20,24) | N6 -> N6 -> N6 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ordenación (A20) y apertura del popup de selección de cascos (A24). |
| 252 | (20b,12) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Ordenación por tipo (A20b) y confirmación de selección (A12). |
| 253 | (20b,12b) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Ordenación por tipo (A20b) y cancelación (A12b). |
| 254 | (20b,12c) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Ordenación por tipo (A20b) y botón atrás (A12c). |
| 255 | (20b,20) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Cambio de ordenación en N6: de Tipo (A20b) a Matrícula (A20). |
| 256 | (20b,20b) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Re-aplicación de orden por tipo en N6. |
| 257 | (20b,20c) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Cambio de ordenación en N6: de Tipo (A20b) a Precio (A20c). |
| 258 | (20b,23) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Ordenación por tipo (A20b) y ver detalles de quad (A23). |
| 259 | (20b,24) | N6 -> N6 -> N6 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ordenación por tipo (A20b) y ajuste de cascos (A24). |
| 260 | (20c,12) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Ordenación por precio (A20c) y confirmación de reserva (A12). |
| 261 | (20c,12b) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Ordenación por precio (A20c) y cancelación de selección (A12b). |
| 262 | (20c,12c) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Ordenación por precio (A20c) y atrás físico (A12c). |
| 263 | (20c,20) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Cambio de Precio (A20c) a Matrícula (A20). |
| 264 | (20c,20b) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Cambio de Precio (A20c) a Tipo (A20b). |
| 265 | (20c,20c) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Re-aplicación de filtro por precio en N6. |
| 266 | (20c,23) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Ordenación por precio (A20c) y consulta de detalles (A23). |
| 267 | (20c,24) | N6 -> N6 -> N6 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ordenación por precio (A20c) y selector de cascos (A24). |
| 268 | (21,1) | N2 -> N1 -> N2 | QuadListActivity.java, SistemaReservas.java | Retorno de listado de quads al menú (A21) y re-entrada al mismo (A1). |
| 269 | (21,2) | N2 -> N1 -> N4 | QuadListActivity.java, SistemaReservas.java | Salida de quads (A21) y apertura de listado de reservas (A2). |
| 270 | (21,3) | N2 -> N1 -> N3 | QuadListActivity.java, SistemaReservas.java | Salida de quads (A21) y apertura de creación de nuevo quad (A3). |
| 271 | (21,4) | N2 -> N1 -> N5 | QuadListActivity.java, SistemaReservas.java | Salida de quads (A21) y apertura de creación de nueva reserva (A4). |
| 272 | (22,1) | N4 -> N1 -> N2 | ReservaListActivity.java, SistemaReservas.java | Retorno de listado de reservas (A22) y apertura de listado de quads (A1). |
| 273 | (22,2) | N4 -> N1 -> N4 | ReservaListActivity.java, SistemaReservas.java | Salida de reservas (A22) y re-entrada al listado de reservas (A2). |
| 274 | (22,3) | N4 -> N1 -> N3 | ReservaListActivity.java, SistemaReservas.java | Salida de reservas (A22) y apertura de creación de quad (A3). |
| 275 | (22,4) | N4 -> N1 -> N5 | ReservaListActivity.java, SistemaReservas.java | Salida de reservas (A22) y apertura de creación de reserva (A4). |
| 276 | (23,12) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Ver detalles de quad (A23) y confirmar la selección del mismo (A12). |
| 277 | (23,12b) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Ver detalles (A23) y cancelar la selección (A12b). |
| 278 | (23,12c) | N6 -> N6 -> N5 | QuadSelectionActivity.java | Ver detalles (A23) y atrás físico (A12c). |
| 279 | (23,20) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Ver detalles (A23) y ordenar por matrícula (A20). |
| 280 | (23,20b) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Ver detalles (A23) y ordenar por tipo (A20b). |
| 281 | (23,20c) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Ver detalles (A23) y ordenar por precio (A20c). |
| 282 | (23,23) | N6 -> N6 -> N6 | QuadSelectionActivity.java | Ver detalles de un quad (A23) y luego de otro diferente (A23). |
| 283 | (23,24) | N6 -> N6 -> N6 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ver detalles (A23) y ajustar número de cascos (A24). |
| 284 | (24,12) | N6 -> N6 -> N5 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ajustar cascos (A24) y confirmar selección de vehículos (A12). |
| 285 | (24,12b) | N6 -> N6 -> N5 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ajustar cascos (A24) y cancelar selección (A12b). |
| 286 | (24,12c) | N6 -> N6 -> N5 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ajustar cascos (A24) y salir por botón atrás (A12c). |
| 287 | (24,20) | N6 -> N6 -> N6 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ajustar cascos (A24) y ordenar por matrícula (A20). |
| 288 | (24,20b) | N6 -> N6 -> N6 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ajustar cascos (A24) y ordenar por tipo (A20b). |
| 289 | (24,20c) | N6 -> N6 -> N6 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ajustar cascos (A24) y ordenar por precio (A20c). |
| 290 | (24,23) | N6 -> N6 -> N6 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ajustar cascos (A24) y ver detalles técnicos del quad (A23). |
| 291 | (24,24) | N6 -> N6 -> N6 | QuadSelectionActivity.java, QuadSelectionAdapter.java | Ajuste repetido del número de cascos para un quad seleccionado. |
...
| 299 | (4,19) | N1 -> N5 -> N5 | SistemaReservas.java, ReservaEdit.java | Inicio de reserva (A4). Se pulsa selector de fecha de recogida (A19). |
| 300 | (4,19b) | N1 -> N5 -> N5 | SistemaReservas.java, ReservaEdit.java | Inicio de reserva (A4). Se pulsa selector de fecha de devolución (A19b). |
...
| 310 | (6,21) | N3 -> N2 -> N1 | QuadEdit.java, QuadListActivity.java | Guardado de cambios (A6) y retorno al menú principal (A21). |
...
| 316 | (6b,21) | N3 -> N2 -> N1 | QuadEdit.java, QuadListActivity.java | Cancelación de edición (A6b) y retorno al menú principal (A21). |
...
| 322 | (6c,21) | N3 -> N2 -> N1 | QuadEdit.java, QuadListActivity.java | Salida por atrás (A6c) y retorno al menú (A21). |
...
| 337 | (8,19) | N4 -> N5 -> N5 | ReservaListActivity.java, ReservaEdit.java | Edición de reserva (A8) y ajuste de fecha de recogida (A19). |
| 338 | (8,19b) | N4 -> N5 -> N5 | ReservaListActivity.java, ReservaEdit.java | Edición de reserva (A8) y ajuste de fecha de devolución (A19b). |
...
| 352 | (9,22) | N5 -> N4 -> N1 | ReservaEdit.java, ReservaListActivity.java | Guardado de edición (A9) y retorno al menú principal (A22). |
...
| 364 | (9b,22) | N5 -> N4 -> N1 | ReservaEdit.java, ReservaListActivity.java | Cancelación (A9b) y volver al menú (A22). |
...
| 376 | (9c,22) | N5 -> N4 -> N1 | ReservaEdit.java, ReservaListActivity.java | Salida de N5 por botón atrás físico (A9c) y retorno al menú principal (A22) desde el listado. |
...
| 5 | (4,11) | N1 -> N5 -> N6 | ReservaEdit.java | **Imposible por Validación:** El botón de selección de quads (A11) está condicionado a que las fechas (A19, A19b) no estén vacías. |
