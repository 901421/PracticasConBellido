...
public class SistemaReservas extends AppCompatActivity {
    ...
    /** @return El repositorio de quads (uso exclusivo para tests). */
    public es.unizar.eina.SistemaReservas.database.QuadRepository getQuadRepository() {
        return mQuadViewModel.getRepository();
    }

    /** @return El repositorio de reservas (uso exclusivo para tests). */
    public es.unizar.eina.SistemaReservas.database.ReservaRepository getReservaRepository() {
        return mReservaViewModel.getRepository();
    }
